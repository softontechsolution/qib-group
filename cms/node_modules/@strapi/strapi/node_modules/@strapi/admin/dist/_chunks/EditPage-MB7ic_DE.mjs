...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-QXnY1tED.mjs";
...
import { u as useWebhooks } from "./useWebhooks-J6ctP7xE.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-_Sjd60rm.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-MB7ic_DE.mjs.map
