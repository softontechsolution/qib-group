...
const useWebhooks = require("./useWebhooks-9KD1Lo7Z.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-QFx2TI60.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-Rkprr51L.js.map
