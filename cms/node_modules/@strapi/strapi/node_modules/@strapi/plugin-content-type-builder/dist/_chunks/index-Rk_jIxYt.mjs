...
const ListView$1 = lazy(() => import("./ListView-et7K3p2B.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-et7K3p2B.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-Rk_jIxYt.mjs.map
