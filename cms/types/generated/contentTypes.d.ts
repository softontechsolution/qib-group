...
export interface ApiAboutGalleryAboutGallery
  extends Struct.CollectionTypeSchema {
  collectionName: 'about_galleries';
  info: {
    displayName: 'About Gallery';
    pluralName: 'about-galleries';
    singularName: 'about-gallery';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::about-gallery.about-gallery'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    companyStory: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiAboutSlideAboutSlide extends Struct.CollectionTypeSchema {
  collectionName: 'about_slides';
  info: {
    displayName: 'About Slides';
    pluralName: 'about-slides';
    singularName: 'about-slide';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiCeoProfileCeoProfile extends Struct.SingleTypeSchema {
...
export interface ApiInsuranceBenefitInsuranceBenefit
  extends Struct.CollectionTypeSchema {
  collectionName: 'insurance_benefits';
  info: {
    displayName: 'Insurance Benefits';
    pluralName: 'insurance-benefits';
    singularName: 'insurance-benefit';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::insurance-benefit.insurance-benefit'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
...
export interface ApiInsuranceFeatureInsuranceFeature
  extends Struct.CollectionTypeSchema {
  collectionName: 'insurance_features';
  info: {
    displayName: 'Insurance Features';
    pluralName: 'insurance-features';
    singularName: 'insurance-feature';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::insurance-feature.insurance-feature'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
...
export interface ApiInsurancePageInsurancePage extends Struct.SingleTypeSchema {
  collectionName: 'insurance_pages';
  info: {
    displayName: 'Insurance Page';
    pluralName: 'insurance-pages';
    singularName: 'insurance-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::insurance-page.insurance-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiInsurancePolicieInsurancePolicie
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::insurance-policie.insurance-policie'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
...
export interface ApiInsuranceSlideInsuranceSlide
  extends Struct.CollectionTypeSchema {
  collectionName: 'insurance_slides';
  info: {
    displayName: 'Insurance Slides';
    pluralName: 'insurance-slides';
    singularName: 'insurance-slide';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::insurance-slide.insurance-slide'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
...
export interface ApiLoginSlideLoginSlide extends Struct.CollectionTypeSchema {
  collectionName: 'login_slides';
  info: {
    displayName: 'Login Slides';
    pluralName: 'login-slides';
    singularName: 'login-slide';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiStrategicPartnerStrategicPartner
  extends Struct.CollectionTypeSchema {
  collectionName: 'strategic_partners';
  info: {
    displayName: 'Strategic Partners';
    pluralName: 'strategic-partners';
    singularName: 'strategic-partner';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::strategic-partner.strategic-partner'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::about-gallery.about-gallery': ApiAboutGalleryAboutGallery;
      ...
      'api::insurance-benefit.insurance-benefit': ApiInsuranceBenefitInsuranceBenefit;
      'api::insurance-feature.insurance-feature': ApiInsuranceFeatureInsuranceFeature;
